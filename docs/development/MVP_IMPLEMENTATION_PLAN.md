...
| Strict Issue Sync | [TASK-CICD-ISSUE-SYNC-STRICT-001](tasks/TASK-CICD-ISSUE-SYNC-STRICT-001.md) | `livemask-docs` / `livemask-ci-cd` | Ready | Follow-up task to search/update docs and runtime repo Issues by TASK ID, fail on ambiguous matches, and write issue references into the ledger. | Implement after ledger/reconciler lands. |
