...
| Issue Close Guard | [TASK-CICD-ISSUE-CLOSE-GUARD-001](tasks/TASK-CICD-ISSUE-CLOSE-GUARD-001.md) | `livemask-ci-cd` / `livemask-docs` | Ready | Follow-up to safely close/reopen child Issues only after final evidence. Must refuse Epic close from child evidence and refuse `completed_with_skip` closure. | Implement after strict issue sync is stable. |
